                            ...
                            this.state.conferences.map(
                                conference =>
                                    <tr key={conference.id}>
                                        ...
                                        <td>
                                            <button onClick={ () => this.updateconference(conference.id)} className="btn btn-info">Approve</button>
                                            <button style={{marginLeft: "10px"}} onClick={ () => this.deleteconference(conference.id)} className="btn btn-danger">Reject</button>
